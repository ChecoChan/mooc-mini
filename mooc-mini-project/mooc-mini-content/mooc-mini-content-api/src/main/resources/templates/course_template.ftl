...
<head>
    ...
    <title>mooc-mini-${model.courseBase.name}</title>
...
<div class="article-banner">
    ...
    <div class="banner-info">
        ...
        <div class="banner-rit">
            <p>
                <a href="http://www.mooc-mini.cn/course/preview/learning.html?id=${model.courseBase.id}" target="_blank">
                    <#if model.courseBase.pic??>
                        <img src="http://file.mooc-mini.cn${model.courseBase.pic}" alt="" width="270" height="156">
                    <#else>
                                ...
                                <div class="drop-down" style="height: 260px;">
                                    <ul class="list-box">
                                        <#list firstNode.teachPlanTreeNodes as secondNode>
                                            <li><a href="http://www.mooc-mini.cn/course/preview/learning.html?id=${model.courseBase.id}&chapter=${secondNode.teachplanMedia.teachplanId!''}" target="_blank">${secondNode.pname}</a></li>
                                        </#list>
                                    </ul>
                                </div>
                            </div>
