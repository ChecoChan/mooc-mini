package com.checo.moocmini.search.service.impl;

import com.alibaba.fastjson.JSON;
import com.checo.moocmini.base.exception.MoocMiniException;
import com.checo.moocmini.search.service.IndexService;
...
public class IndexServiceImpl implements IndexService {
    ...
    public Boolean addCourseIndex(String indexName, String id, Object object) {
        ...
        try {
            ...
            e.printStackTrace();
            MoocMiniException.castException("添加索引出错");
        }
    ...
    public Boolean updateCourseIndex(String indexName, String id, Object object) {
        ...
        try {
            ...
            e.printStackTrace();
            MoocMiniException.castException("更新索引出错");
        }
    ...
    public Boolean deleteCourseIndex(String indexName, String id) {
        ...
        try {
            ...
            e.printStackTrace();
            MoocMiniException.castException("删除索引出错");
        }
        //获取响应结果
