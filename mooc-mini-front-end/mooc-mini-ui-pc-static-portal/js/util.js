...
function setCookie(name,value,Days){
    if(Days==0){
        document.cookie = name + "="+ escape (value) + ";domain=mooc-mini.cn;expires=0;path=/" ;
    }else{
        var exp = new Date();
        exp.setTime(exp.getTime() + Days*24*60*60*1000);
        document.cookie = name + "="+ escape (value) + ";domain=mooc-mini.cn;expires=" + exp.toGMTString()+";path=/";
    }
...
function showlogin(){
    window.location = "http://www.mooc-mini.cn/sign.html?returnUrl="+ Base64.encode(window.location)
}